...
const money = {
  ...
  properties: {
    value: {
      type: 'string',
      description: 'Decimal amount as a string, e.g. "35.50".',
    },
    ...
    components: {
      securitySchemes: {
        bearerAuth: {
          ...
          scheme: 'bearer',
          description:
            'Required only for write actions when the deployment sets PAYLA_API_KEY.',
        },
      },
      schemas: {
        Money: money,
        ...
        Refund: {
          ...
          properties: {
            ...
            status: {
              type: 'string',
              enum: ['queued', 'pending', 'processing', 'refunded', 'failed'],
            },
        ...
        Settlement: {
          ...
          properties: {
            ...
            status: {
              type: 'string',
              enum: ['open', 'pending', 'paidout', 'failed'],
            },
            createdAt: { type: 'string', format: 'date-time' },
    ...
    paths: {
      '/api/balance': {
        get: {
          ...
          description:
            "Use when a merchant asks how much money they have, what's available to pay out, or what's still pending.",
          responses: {
            '200': {
              description: 'Balance',
              content: {
      ...
      '/api/metrics': {
        get: {
          ...
          summary:
            'Get 30-day revenue, payment count, success rate and method breakdown.',
          description:
            'Use for questions about sales performance, revenue trends, conversion/success rate, average order value, or which payment methods customers use.',
      ...
      '/api/payments': {
        get: {
          ...
          summary:
            'List recent payments, optionally filtered by status, method or customer.',
          description:
            "Use to find a customer's recent orders, review failed/expired payments, or list refunded ones. Filter by customer to answer 'where is my order' type questions.",
          parameters: [
            {
              name: 'status',
              in: 'query',
              required: false,
              schema: {
                $ref: '#/components/schemas/Payment/properties/status',
              },
            ...
            },
            {
              ...
              schema: { type: 'string' },
              description:
                'Filter by payment method (creditcard, paypal, applepay, ...).',
            },
            {
              name: 'customer',
              in: 'query',
              required: false,
              schema: { type: 'string' },
              description: 'Filter by customer id (cst_...).',
            },
            limitParam,
          ],
          responses: {
      ...
      '/api/payments/{id}': {
        get: {
          ...
          description:
            'Use when the merchant references a specific payment/order id (tr_...) and you need its status, amount, method and refund history.',
          parameters: [
            {
              name: 'id',
              in: 'path',
          ...
          responses: {
            '200': {
              description: 'Payment with refunds',
              content: {
                'application/json': {
      ...
      '/api/payments/{id}/refunds': {
        post: {
          ...
          description:
            "Use to issue a refund for a paid payment. Omit amount for a full refund of the remaining balance; pass amount (in euros) for a partial refund. Only 'paid' or 'partially_refunded' payments can be refunded. This changes real data — confirm the amount and payment with the merchant first.",
          parameters: [
            {
              name: 'id',
              in: 'path',
                ...
                schema: {
                  ...
                  properties: {
                    amount: {
                      type: 'number',
                      description:
                        'Refund amount in major units (euros). Omit for a full refund.',
                    },
          ...
          responses: {
            ...
            '422': {
              description: 'Not refundable / invalid',
              content: {
                'application/json': {
                  schema: { $ref: '#/components/schemas/Error' },
                },
        ...
        get: {
          ...
          responses: {
            '200': {
              ...
              content: {
                'application/json': {
                  schema: listResponse('#/components/schemas/Refund'),
                },
              },
            },
          },
        ...
        get: {
          ...
          responses: {
            '200': {
              ...
              content: {
                'application/json': {
                  schema: listResponse('#/components/schemas/Customer'),
                },
              },
            },
          },
      ...
      '/api/customers/{id}': {
        get: {
          ...
          description:
            "Use to look up a customer's profile, lifetime spend and recent orders.",
          parameters: [
            {
              name: 'id',
              in: 'path',
          ...
          responses: {
            '200': {
              description: 'Customer with payments',
              content: {
                'application/json': {
      ...
      '/api/payment-links': {
        get: {
          ...
          responses: {
            '200': {
              ...
              content: {
                'application/json': {
                  schema: listResponse('#/components/schemas/PaymentLink'),
                },
              },
            },
          },
        ...
        post: {
          ...
          description:
            'Use when a merchant wants to charge a customer without an integration — e.g. an invoice, deposit or one-off charge. Returns a URL to share. This creates real data.',
          requestBody: {
            required: true,
            content: {
              'application/json': {
                schema: {
                  ...
                  properties: {
                    amount: {
                      type: 'number',
                      description: 'Amount in major units (euros), e.g. 49.99.',
                    },
      ...
      '/api/settlements': {
        get: {
          ...
          description:
            "Use for payout questions: what's been paid out, what's pending, and the amounts per settlement.",
          parameters: [limitParam],
          responses: {
            '200': {
              ...
              content: {
                'application/json': {
                  schema: listResponse('#/components/schemas/Settlement'),
                },
              },
            },
          },
      ...
      '/api/disputes': {
        get: {
          ...
          description:
            'Use for questions about chargebacks, disputes, or amounts at risk and their response deadlines.',
          parameters: [limitParam],
          responses: {
            '200': {
              ...
              content: {
                'application/json': {
                  schema: listResponse('#/components/schemas/Dispute'),
                },
              },
            },
          },
      ...
      '/api/settings': {
        get: {
          ...
          summary:
            "Get the merchant's account settings (payout schedule, descriptor, test mode).",
          responses: {
            '200': {
