      ...
      {isLoading || !customer ? (
        ...
        <>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <a
                ...
                className="mt-0.5 inline-flex items-center gap-1.5 text-[13px] text-link hover:underline"
              >
          ...
          <div className="grid grid-cols-2 gap-4 lg:grid-cols-3">
            ...
            <StatTile
              label="Payments"
              value={formatNumber(customer.paymentsCount)}
            />
            <StatTile
          ...
          <Card>
            ...
            <PaymentsTable
              ...
              showCustomer={false}
              emptyLabel="No payments from this customer"
            />
          </Card>
