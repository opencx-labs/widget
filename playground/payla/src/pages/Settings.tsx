...
import { BOT_NAME, getWidgetConfig } from '../lib/widgetConfig.ts';
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-ink">{BOT_NAME}</span>
      ...
      <Card>
        ...
        {isLoading || !data ? (
          ...
          <dl className="divide-y divide-border px-5 py-1">
            ...
            <KeyValue label="Statement descriptor">
              {data.statementDescriptor}
            </KeyValue>
            <KeyValue label="Payout schedule">
              {statusLabel(data.payoutSchedule)}
            </KeyValue>
