    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-0.5 text-[13px] text-ink-3">
          Here's how your store is doing over the last 30 days.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <StatTile
          ...
          sub={
            balance.data
              ? `${formatMoney(balance.data.pending)} pending`
              : undefined
          }
        ...
        <Card className="lg:col-span-2">
          <CardHeader
            ...
            action={
              <Link
                to="/payments"
                className="focusable inline-flex items-center gap-1 rounded-md text-[13px] font-medium text-link hover:underline"
              >
          ...
          <Card>
            ...
            <div className="space-y-3 px-5 py-4">
              {(m?.methodBreakdown ?? []).slice(0, 6).map((row) => {
                const total =
                  m?.methodBreakdown.reduce(
                    (a, r) => a + Number(r.amount.value),
                    0,
                  ) || 1;
                ...
                <div className="flex items-start gap-3 px-5 py-4">
                  ...
                  <div>
                    ...
                    <div className="mt-0.5 text-[13px] text-ink-2">
                      Respond before the deadline to avoid losing the
                      chargeback.
                    </div>
                  </div>
                </div>
