...
const TOPICS = [
  {
    title: 'Payments',
    blurb:
      'Statuses, methods, failed payments, and what your customers see at checkout.',
  },
  {
    title: 'Refunds',
    blurb:
      'How refunds work, how long they take, and what happens to your balance.',
  },
  {
    title: 'Settlements & payouts',
    blurb:
      'When Payla pays out, settlement references, and reconciling your bank statement.',
  },
  {
  ...
  },
  {
    ...
    blurb:
      'Verification, supported countries and currencies, and account settings.',
  },
];
      ...
      <main className="mx-auto max-w-5xl px-6 py-16">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-[15px] text-ink-3">
            Browse a topic below, or ask Payla Support directly — the chat
            bubble in the corner answers from our help center and can look
            things up for you.
          </p>
        </div>
        ...
        <p className="mt-16 text-center text-[13px] text-ink-3">
          Can't find what you need? Start a chat — we'll hand you to a human
          when it matters.
        </p>
      </main>
    </div>
