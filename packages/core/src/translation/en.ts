...
export const EnglishLanguage: TranslationInterface = {
  ...
  companion_close_chat: 'Close {title}',
  companion_close: 'Close',
  companion_switch_chat: 'Switch chat',
  companion_viewing: 'Viewing',
  companion_working: 'Working',
  companion_open: 'Open',
  companion_closed: 'Closed',
  companion_draft: 'Draft',
  companion_chats: 'Active sessions',
  companion_chat_number: 'Chat {count}',
  ...
  send_queued_now: 'Send queued messages now',
